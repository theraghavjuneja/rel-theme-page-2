    ...
    <div className="min-h-screen bg-amber-50 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8" ref={contentRef}>
        ...
        <div className="space-y-3 text-lg">
          ...
          <p className="text-justify">समय बहुत कम है। विनाश से पहले परमात्मा ज्ञान, योग सीख कर अपना भाग्य बनाना है। संगम युग 100 साल का है। भगवान का अवतरण माउंट आबू में 88 साल पहले हो चुका है और अब 11 साल बाकी हैं।</p>
